...
public class Configuration {
    ...
    public static String Paper_Model_Path=projectRoot+"/resources/paper2vecmodel";
    public static String stopWords=projectRoot+"/resources/models/stopwords/stop-word-list.txt";
}
